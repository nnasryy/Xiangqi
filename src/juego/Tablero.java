...
public class Tablero extends JPanel {
    ...
    private java.util.function.BiConsumer<piezas.Pieza, String> onCaptura;
    ...
    public void setOnCaptura(java.util.function.BiConsumer<piezas.Pieza, String> c) { onCaptura = c; }

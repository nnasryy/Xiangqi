...
public class MenuPrincipal {
    ...
    public MenuPrincipal(Sistema sistema, Usuario actual) {
        ...
        jugar.addActionListener(e -> {
            frame.dispose();
            new SeleccionOponente(sistema, actual);
        });
        bg.add(jugar);
        ...
        efectoHover(salir, "src/images/salirmenup.png", "src/images/hoversalirmenup.png");
